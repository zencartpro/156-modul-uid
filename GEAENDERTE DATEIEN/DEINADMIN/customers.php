...
if ($error == true) {
if ($entry_tva_intracom_error == 'true') {
echo zen_draw_input_field('entry_tva_intracom', $cInfo->entry_tva_intracom, zen_set_field_length(TABLE_ADDRESS_BOOK, 'entry_tva_intracom', 32). ' class="form-control"') . '&nbsp;' . ENTRY_CONTROL_TVA_INTRACOM ;
} 
if ($entry_tva_intracom_error == 'no_verif') {
echo zen_draw_input_field('entry_tva_intracom', '', zen_set_field_length(TABLE_ADDRESS_BOOK, 'entry_tva_intracom', 32). ' class="form-control"') . '&nbsp;' . ENTRY_NO_VERIF_TVA_INTRACOM;
} 
if ($entry_tva_intracom_error == 'false') {
echo $cInfo->entry_tva_intracom . zen_draw_hidden_field('entry_tva_intracom');
}
} else {
echo zen_draw_input_field('entry_tva_intracom', $cInfo->entry_tva_intracom, zen_set_field_length(TABLE_ADDRESS_BOOK, 'entry_tva_intracom', 32). ' class="form-control"');
}
} else {
if ($error == true) {
if ($entry_tva_intracom_error == 'true') {
echo zen_draw_input_field('entry_tva_intracom', $cInfo->entry_tva_intracom, zen_set_field_length(TABLE_ADDRESS_BOOK, 'entry_tva_intracom', 32). ' class="form-control"') . '&nbsp;' . ENTRY_TVA_INTRACOM_ERROR;
} else {
echo $cInfo->entry_tva_intracom . zen_draw_hidden_field('entry_tva_intracom');
}
} else {
